...
class ParaphrasingSuggestions(Enum):
    ...
    RELEVANCY = 'It is very important to first read the given paragraph carefully and understand the context. Only ' \
                'then you can successfully paraphrase the provided paragraph. Please be more cautious about the ' \
    ...
    GOOD = 'Congratulations on your great score! Your hard work and dedication surely impacted your result. Very ' \
           'well done!',
    COPIED = 'Your answer needs to be in your own words. Rewriting the original paragraph is not paraphrasing. ' \
             'Please refer the introduction again to understand the art of paraphrasing.',
